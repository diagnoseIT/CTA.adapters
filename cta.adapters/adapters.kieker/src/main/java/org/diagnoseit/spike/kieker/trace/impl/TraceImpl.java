...
import org.diagnoseit.spike.kieker.trace.impl.util.CtaToKiekerTraceConverter;
import org.diagnoseit.spike.kieker.trace.impl.util.KiekerToCtaTraceConverter;
 ...
 *
 */
public class TraceImpl extends AbstractIdentifiableImpl implements Trace,
		Serializable {
	// |============|
	// | attributes |
	// |============|
	...
	public SubTraceImpl rootSubTrace;
	...
	public static TraceImpl createCallableTrace(MessageTrace messageTrace) {
		...
		KiekerToCtaTraceConverter traceConverter = new KiekerToCtaTraceConverter(
				trace, messages.iterator());
	...
	public static MessageTrace createMessageTrace(TraceImpl trace) {
		CtaToKiekerTraceConverter traceConverter = new CtaToKiekerTraceConverter(
				trace.iterator());
		...
		// return
		MessageTrace createdMessageTrace = new MessageTrace(trace.getTraceId(),
				messages);
