...
/**
 * Uses Kieker's analysis component and {@link CTAFilter} to convert Kieker
 * traces into CTA.
 * 
...
public class TraceConversion {
	...
	private static final String folderPath_KiekerLogs = "D:/diagnoseIT/KiekerLogs";
	private static final String[] trace_folders = {
			folderPath_KiekerLogs
					+ "/kieker-20150730-135303927-UTC-edge2.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135300977-UTC-lb.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135301325-UTC-rssserver.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135301407-UTC-rssserver2.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135301705-UTC-db.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135303897-UTC-edge.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135303927-UTC-edge2.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135316692-UTC-middletier.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135316914-UTC-middletier2.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135316975-UTC-middletier3.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135327483-UTC-eureka.rssreader.rssperf.emulab.net-KIEKER",
			folderPath_KiekerLogs
					+ "/kieker-20150730-135805914-UTC-client.rssreader.rssperf.emulab.net-KIEKER" };
	...
	public static void runAnalysis(LinkedBlockingQueue<Trace> traceList)
			throws AnalysisConfigurationException {
		runAnalysis(traceList, trace_folders);
	}

	public static void runAnalysis(LinkedBlockingQueue<Trace> traceList,
			String[] traceFolders) throws AnalysisConfigurationException {
		...
		fsReaderConfig.setStringArrayProperty(
				FSReader.CONFIG_PROPERTY_NAME_INPUTDIRS, traceFolders);
		...
		final CTAFilter ctaFilter = new CTAFilter(new Configuration(),
				analysisController);
