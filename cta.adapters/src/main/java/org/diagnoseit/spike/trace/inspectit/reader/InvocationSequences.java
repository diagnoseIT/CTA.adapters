...
public class InvocationSequences implements Iterable<InvocationSequenceData> {
	 ...
	 * 
	 * @param isData
	 *            the {@link InvocationSequenceData} instance to retrieve the
	 *            method name for
	 * @return the method name, or null if method name cannot be found for the
	 *         given {@link InvocationSequenceData} instance
	 */
